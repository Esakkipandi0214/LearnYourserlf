      ...
      <div className="container mx-auto  sm:p-4">
        <Card className="shadow-lg rounded-xl">
          <CardContent className="p-4">
            <h2 className=" text-lg lg:text-2xl font-semibold mb-4">Test Results</h2>
              ...
              <Table className="min-w-full">
                <TableHeader>
                  <TableRow className="bg-gray-200">
                    ...
                    <TableHead className=" px-32 lg:px-4 py-2 whitespace-nowrap">Test Title</TableHead>
                    ...
                    <TableHead className="px-28 lg:px-4 py-2 whitespace-nowrap">Submitted At</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {formattedResults.map((result,index) => (
                    <TableRow key={result._id} className="border-b">
                      ...
                      <TableCell className="px-14 flex justify-center items-center sm:px-4 py-2">{result.testTitle}</TableCell>
